...
public class MeetingViewModel implements PropertyChangeListener{
  ...
  public void editMeeting(Date oldStartDate, Date oldEndDate, Date startDate, Date endDate, String description, ArrayList<User> employees)
  {
  ...
  public boolean checkUser()
  {
    ...
    {
      if ("Reload meetings".equals(evt.getPropertyName())) {
